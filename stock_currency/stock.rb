# https://github.com/tyrauber/stock_quote 사이트 참고
require "stock_quote"
...
if stocks.is_a? Array #배열일 경우
    stocks.each do |stock|
        puts "#{stock.company_name}의 1주당 가격은 $ #{stock.latest_price}입니다."
    end

else #한개일 경우
    puts "#{stocks.company_name}의 1주당 가격은 $ #{stocks.latest_price}입니다."
end